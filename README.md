...
The Skyrim Inventory Management API is a basic Rails API running on Rails 7 and Ruby 3.3.0. You can set it up locally by cloning the repository, `cd`ing into it, and running:
```bash
./script/setup.sh
```
